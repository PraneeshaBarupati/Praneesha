app.controller('eventController', [ 'eventFactory', function(eventFactory) {
	...
	function fetchAllEvents() {
		eventFactory.fetchAllEvents().then(function(data) {
			self.events = data;
			console.log(data);
	...
	function createEvent(event) {
		debugger;
		eventFactory.createEvent(event).then(function(data) {
	...
	function updateEvent(event, eventId) {
		eventFactory.updateEvent(event, eventId).then(function(data) {
