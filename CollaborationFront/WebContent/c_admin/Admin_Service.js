app.factory('adminFactory', [
		...
		function($http, $q) {
			...
			function approveBlog(blogId) {
				var deferred = $q.defer();
				$http.put(blogAddress + 'approve/' + blogId).then(
						function(response) {
							deferred.resolve(response.data);
						}, function(errResponse) {
							deferred.reject(errResponse);
			...
			function disapproveBlog(blogId) {
				var deferred = $q.defer();
				$http.put(blogAddress + 'disapprove/' + blogId).then(
						function(response) {
							deferred.resolve(response.data);
						}, function(errResponse) {
							deferred.reject(errResponse);
			...
			function approveForum(forumId) {
				var deferred = $q.defer();
				$http.put(forumAddress + 'approve/' + forumId).then(
						function(response) {
							deferred.resolve(response.data);
						}, function(errResponse) {
							deferred.reject(errResponse);
			...
			function disapproveForum(forumId) {
				var deferred = $q.defer();
				$http.put(forumAddress + 'disapprove/' + forumId).then(
						function(response) {
							deferred.resolve(response.data);
						}, function(errResponse) {
							deferred.reject(errResponse);
