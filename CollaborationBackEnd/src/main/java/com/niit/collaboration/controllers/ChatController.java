...
public class ChatController {
	...
	/*
	 * @RequestMapping(value = "/myChats", method = RequestMethod.GET) public
	 * ResponseEntity<List<Chat>> getMyChats(HttpSession session) {
	 * logger.debug("calling method getMyChats"); User loggedInUser = (User)
	 * session.getAttribute("loggedInUser"); List<Chat> myChats =
	 * chatDAO.get(loggedInUser.getId()) ; return new
	 * ResponseEntity<List<Chat>>(myChats, HttpStatus.OK); }
	 */
